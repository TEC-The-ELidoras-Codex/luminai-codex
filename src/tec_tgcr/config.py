...
class AgentConfig:
    ...
    research_sources: List[str] = field(
        default_factory=lambda: ["web", "academic", "news", "social"]
    )
    ...
    def _load_from_environment(self):
        ...
        self.max_research_depth = int(
            os.getenv("MAX_RESEARCH_DEPTH", self.max_research_depth)
        )
