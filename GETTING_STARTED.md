...
- `docs/operations/LUMINAI_SYSTEMATIC_MIGRATION_STRATEGY.md` — 4-week execution plan
- `docs/brand/LUMINAI_LOGO_AND_BRANDING_SPECIFICATIONS.md` — Visual identity system
- `docs/operations/LUMINAI_ASSETS_INVENTORY_AND_TRANSFER_PLAN.md` — Content migration roadmap
